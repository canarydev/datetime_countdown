...
const datetimeCountdownField = {
    component: DatetimeCountdownField,
    displayName: _t("Datetime Countdown"),
    supportedTypes: ["datetime"],
};

const fieldsRegistry = registry.category("fields");
if (!fieldsRegistry.contains("datetime_countdown")) {
    fieldsRegistry.add("datetime_countdown", datetimeCountdownField);
}
if (!fieldsRegistry.contains("list.datetime_countdown")) {
    fieldsRegistry.add("list.datetime_countdown", datetimeCountdownField);
}
if (!fieldsRegistry.contains("datetime_countdown_widget")) {
    fieldsRegistry.add("datetime_countdown_widget", datetimeCountdownField);
}
if (!fieldsRegistry.contains("list.datetime_countdown_widget")) {
    fieldsRegistry.add("list.datetime_countdown_widget", datetimeCountdownField);
}
